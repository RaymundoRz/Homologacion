/*  public/comparisonWorker_v17.js (v17 - FORZAR RECARGA 2025-08-27)
   -----------------------------------------------------------
   - Versión v17 para forzar recarga completa
   - SIN COMPARACIÓN DE PRECIOS ENTRE ARCHIVOS
   - Solo validación interna de precios
   --------------------------------------------------------- */
...
try {
  ...
  console.log(`🔧 VERSIÓN WORKER: v17 - FORZAR RECARGA - SIN COMPARACIÓN DE PRECIOS`);
  console.log(`🚨🚨🚨 WORKER v17 CARGADO CORRECTAMENTE - VERSIÓN SIN COMPARACIÓN DE PRECIOS 🚨🚨🚨`);
  ...
  console.log('🚨 WORKER v17 CARGADO - VERSIÓN SIN COMPARACIÓN DE PRECIOS');
...
self.onmessage = function(event) {
  try {
    console.log("Worker v17: Mensaje recibido", event.data);
    ...
    console.log("Worker v17: Iniciando procesamiento...");
    
    /* ------------ 1. Procesar archivo base ------------ */
    console.log("Worker v17: Procesando archivo base...");
    console.log("Worker v17: currentData type:", typeof currentData);
    console.log("Worker v17: currentData length:", currentData?.length);
    console.log("Worker v17: currentData[0]:", currentData?.[0]);
    console.log("Worker v17: currentData[1]:", currentData?.[1]);
    ...
    try {
      ...
      console.log("Worker v17: Datos base64 convertidos correctamente");
    } catch (error) {
      console.error("Worker v17: Error convirtiendo base64:", error);
    ...
    try {
      ...
      console.log("Worker v17: Archivo base leído correctamente");
    } catch (error) {
      console.error("Worker v17: Error leyendo archivo base:", error);
    ...
    console.log("Worker v17: currentDataArray length:", currentDataArray?.length);
    console.log("Worker v17: currentDataArray[0]:", currentDataArray?.[0]);
    console.log("Worker v17: currentDataArray[1]:", currentDataArray?.[1]);
    
    let cleanCurrent = normalizeData(currentDataArray);
    console.log(`Worker v17: Archivo base leído, hojas: ${cleanCurrent.length} filas`);
    console.log("Worker v17: cleanCurrent[0]:", cleanCurrent?.[0]);
    console.log("Worker v17: cleanCurrent[1]:", cleanCurrent?.[1]);
    
    /* ------------ 2. Procesar archivo de referencia ------------ */
    console.log("Worker v17: Procesando archivo de referencia...");
    console.log("Worker v17: referenceData type:", typeof referenceData);
    console.log("Worker v17: referenceData length:", referenceData?.length);
    console.log("Worker v17: referenceData[0]:", referenceData?.[0]);
    console.log("Worker v17: referenceData[1]:", referenceData?.[1]);
    ...
    try {
      ...
      console.log("Worker v17: Datos base64 de referencia convertidos correctamente");
    } catch (error) {
      console.error("Worker v17: Error convirtiendo base64 de referencia:", error);
    ...
    try {
      ...
      console.log("Worker v17: Archivo de referencia leído correctamente");
    } catch (error) {
      console.error("Worker v17: Error leyendo archivo de referencia:", error);
    ...
    console.log("Worker v17: referenceDataArray length:", referenceDataArray?.length);
    console.log("Worker v17: referenceDataArray[0]:", referenceDataArray?.[0]);
    console.log("Worker v17: referenceDataArray[1]:", referenceDataArray?.[1]);
    
    let cleanReference = normalizeData(referenceDataArray);
    console.log(`Worker v17: Archivo referencia leído, hojas: ${cleanReference.length} filas`);
    console.log("Worker v17: cleanReference[0]:", cleanReference?.[0]);
    console.log("Worker v17: cleanReference[1]:", cleanReference?.[1]);
    ...
    console.log(`Worker v17: Mapa de referencia creado con ${referenceVersions.size} elementos`);
    
    /* ------------ 4. Detectar diferencias ------------ */
    console.log("Worker v17: Iniciando comparación...");
    ...
    /* ------------ 4. Enviar resultado ---------------- */
    console.log(`Worker v17: Comparación completada. Filas: ${cleanCurrent.length}, Diferencias: ${differenceSet.size}`);
    console.log("Worker v17: Enviando resultado al componente principal...");
    console.log("Worker v17: displayData[0]:", cleanCurrent?.[0]);
    console.log("Worker v17: displayData[1]:", cleanCurrent?.[1]);
    console.log("Worker v17: differences:", Array.from(differenceSet));
    
    self.postMessage({
      displayData: cleanCurrent, // Enviar datos del archivo BASE
      differences: Array.from(differenceSet),
    });
    console.log("Worker v17: Resultado enviado exitosamente");
    console.log("🚨🚨🚨 WORKER v17 EJECUTADO CORRECTAMENTE - SIN COMPARACIÓN DE PRECIOS 🚨🚨🚨");
  } catch (err) {
    console.error("Worker v17 error:", err);
    console.error("Worker v17 error stack:", err.stack);
    const errorMessage = err && err.message ? err.message : 
                        (typeof err === 'string' ? err : 'Error desconocido en el worker');
    console.error("Worker v17: Enviando error al componente principal:", errorMessage);
